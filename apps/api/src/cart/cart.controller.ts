...
export class CartController {
    ...
    addItem(@Request() req: any, @Body() addCartItemDto: AddCartItemDto) {
        return this.cartService.addItem(req.user.id || req.user.sub, addCartItemDto);
    }
    ...
    updateItem(
        ...
        return this.cartService.updateItem(req.user.id || req.user.sub, itemId, updateCartItemDto);
    }
